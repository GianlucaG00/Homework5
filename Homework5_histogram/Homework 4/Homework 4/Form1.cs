       ...
       private void printHistogram()
        {
            ...
            double interval = trialCount / step; // lenghth of the intervals 
        ...
        private void printVerticalHist()
        {
            // Variables
            parseInput();
            ...
            for (int j = 0; j < repeat; j++)
            {
                ...
                foreach (int k in count)
                {
                    int hr = fromXRealToXVirtual(k, 0, repeat, 0, b1.Height);
                    int sr = fromXRealToXVirtual(interval, minX, maxX, 0, b1.Width);
                    int xr = fromYRealToYVirtual(kk * interval, minX, maxX, 0, b1.Width);
                    rectangles.Add(new Rectangle(xr, (int) (b1.Height - hr), sr, hr));
                    kk++;
                }
                kk = 1;
                g1.FillRectangles(brush1, rectangles.ToArray());
